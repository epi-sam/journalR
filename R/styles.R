...
get_style_schema <- function(){
   list(
      ...
      , prop_nsmall            = "integer"
      , prop_invert_all_neg_UI = "logical"
      ...
      , count_invert_all_neg_UI = "logical"
      ...
      , rate_nsmall            = "integer"
      , rate_invert_all_neg_UI = "logical"
...
new_style <- function(
   ...
   set_style(
      ...
      , style_entry = list(
         ...
         , prop_invert_all_neg_UI  = prop_invert_all_neg_UI
