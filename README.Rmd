...
- All arguments except the name have sensible defaults - only change what you need.
   ...
   - Using the "sigfig" `count_method` option involves the most assumptions, "decimal" and "int" are other options.
...
journalR::new_style(
   style_name            = 'wacky_style_thousands'
   , prop_digits_round   = 3
   , prop_nsmall         = 3
   , count_digits_sigfig = 5
   , count_pad_sigfigs   = TRUE
